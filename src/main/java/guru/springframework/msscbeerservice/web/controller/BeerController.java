...
public class BeerController {
    ...
    @GetMapping(value = "/beer/list", produces = {"application/json"})
    public ResponseEntity<BeerPagedList> listBeers(ListBeerRequest listBeerRequest) {
    ...
    public ResponseEntity<BeerDto> getBeerByUpc(@PathVariable("upc") String upc, @RequestParam(value = "showInventory", required = false) boolean showInventory) {
